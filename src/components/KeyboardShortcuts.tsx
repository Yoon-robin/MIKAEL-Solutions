...
const SHORTCUTS = [
  { key: 'F', desc: '전체 화면 전환' },
  { key: 'G', desc: '3D 글로브 ↔ 2D 지도 전환' },
  { key: 'S', desc: '현재 보기 공유' },
  { key: 'L', desc: '레이어 패널 전환' },
  { key: 'M', desc: '시장 패널 전환' },
  { key: 'I', desc: '정보 피드 전환' },
  { key: 'R', desc: '전세계 보기로 초기화' },
  { key: '?', desc: '단축키 도움말' },
  { key: 'ESC', desc: '패널/팝업 닫기' },
];
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative glass-panel p-6 w-[320px] mikael-glow"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <Keyboard className="w-4 h-4 text-[var(--gold-primary)]" />
                <span className="text-sm font-mono font-bold text-[var(--text-heading)] tracking-wider">단축키</span>
              </div>
