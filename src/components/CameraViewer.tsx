...
export default function CameraViewer({ camera, onClose, onLocate }: CameraViewerProps) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="glass-panel mikael-glow overflow-hidden h-full flex flex-col" style={{ borderColor: 'rgba(57, 255, 20, 0.3)' }}>
          {/* Header */}
            ...
            {loading && !error && !externalOnly && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/80 z-10">
                <div className="text-center">
                  ...
                  <span className="text-[8px] font-mono text-[#39FF14] tracking-widest">피드 연결 중...</span>
                </div>
              </div>
            )}
            ...
            {externalOnly ? (
              <div className="absolute inset-0 flex items-center justify-center bg-black/90">
                <div className="text-center px-6">
                  ...
                  <span className="text-[9px] font-mono text-[#39FF14] tracking-widest block mb-1">외부 피드</span>
                  <span className="text-[7px] font-mono text-[var(--text-muted)]">실시간 영상은 원본 뷰어에서 열립니다</span>
                  {externalFeedUrl && (
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/90">
                <div className="text-center">
                  ...
                  <span className="text-[9px] font-mono text-red-400 tracking-widest block mb-1">피드 사용 불가</span>
                  <span className="text-[7px] font-mono text-[var(--text-muted)]">카메라가 오프라인이거나 접근이 제한됐을 수 있습니다</span>
