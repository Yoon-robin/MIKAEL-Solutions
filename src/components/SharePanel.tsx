...
export default function SharePanel({ mapView, activeLayers, mouseCoords }: SharePanelProps) {
  ...
  const generateShareUrl = useCallback(() => {
    ...
    const base = typeof window !== 'undefined' ? window.location.origin : 'https://43.200.203.218';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-12 right-0 w-72 glass-panel p-4 pointer-events-auto mikael-glow z-[300]"
          >
            ...
            <div className="mb-3 p-2 rounded-lg bg-[var(--bg-void)] border border-[var(--border-primary)]">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[7px] font-mono text-[var(--text-muted)] tracking-widest">현재 보기</span>
              </div>
            ...
            <div className="mb-3">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[7px] font-mono text-[var(--text-muted)] tracking-widest">공유 링크</span>
              </div>
            ...
            <div className="mt-3 text-center text-[6px] font-mono text-[var(--text-muted)] tracking-widest">
              [S]로 열기/닫기 · 공유 링크는 현재 지도 상태를 보존합니다
            </div>
          </motion.div>
        )}
      </AnimatePresence>
