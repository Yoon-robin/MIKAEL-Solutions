...
/**
 * MIKAEL Solutions — Region Dossier API
  ...
  try {
    ...
    const geoRes = await fetch(
      `https://nominatim.openstreetmap.org/reverse?lat=${lat}&lon=${lng}&format=json&zoom=5&addressdetails=1`,
      {
        ...
        headers: { 'User-Agent': 'MikaelSolutionsIntelPlatform/1.0' },
      }
    );
    ...
    const [countryResult, wikiResult, hosResult] = await Promise.allSettled([
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[MIKAEL Solutions] Country fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[MIKAEL Solutions] Wikipedia fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[MIKAEL Solutions] Wikidata fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
    ]);
